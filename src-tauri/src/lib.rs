...
pub fn configure<R: tauri::Runtime>(builder: tauri::Builder<R>) -> tauri::Builder<R> {
    builder
        ...
        // One entry per command, grouped by the module that holds it — the
        // same order as `commands/mod.rs`, so a name is found where it lives.
        .invoke_handler(tauri::generate_handler![
            // shell — the machine around the window
            ...
            // notebook — the open notebook, and the picker
            ...
            // settings — the two drawers of Settings
            ...
            commands::lists::merge_conflicts,
            ...
            commands::notes::set_note_lang,
            commands::notes::detect_language,
            commands::notes::writing_dictionaries,
            commands::notes::apply_spelling,
            ...
            // day — the day, and the days ahead
            ...
            commands::reminders::reminder_scope,
