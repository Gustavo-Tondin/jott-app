...
export const S = {
  ...
  // Display / Interface: the notes board — how it is arranged, and how tall
  // a card may grow. Both answer to this screen.
  ...
  cardLinesValue: (lines) => `${lines} lines`,
