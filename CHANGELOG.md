...
- **Bullets and numbers in a note now read one step back from the text.** A list marker is drawn in a lighter ink than the words it introduces, so the structure of a list is easy to run your eye down.
